...
<body>
	...
	<div class="navbar-fixed">
      ...
      <div class="login-logo">
        <b>HISTÓRICO de Siniestros</b>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        <p class="login-box-msg">En este apartado podrás visualizar los Siniestros que ya estan dados de baja del Sistema web.</p>
		        <form method="post">		          
		          <div class="form-group has-feedback">
		            <input type="text" class="form-control" autocomplete="off" placeholder="Número de Siniestro" name="siniestro" />
			...
			if (mysqli_connect_errno()) {
                echo "<center><p style=\"color:#b40000\"><strong>Falló la conexion al Sistema INSpector.</strong></p></center>";                              
                    ...
                    if(mysqli_num_rows(mysqli_query($conexion,$sql)) == 0){ ?>
                    	<h4 class="red-text">No se ha encontrado el Siniestro. Verifica que el caso que solicitas ya esté dado de BAJA e intentalo nuevamente.</h4>
                    <?php }else{

                     while($row = mysqli_fetch_array($result)){ ?>
                     <ul class="collection">
       						<li class="collection-item dismissable"><a target="_blank" href="../siniestros/ifsinind2.php?siniestro=<?php echo $row['case']; ?>&amp;&amp;asegurado=<?php echo $row['asegurado']; ?>&amp;&amp;vzlcn=hide&amp;&amp;ride=readonly"><?php echo $row['case'] ?><i class="material-icons circle grey darken-3 right white-text">accessibility</i></a></li>
      					</ul> 
